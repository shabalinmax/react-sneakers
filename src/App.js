    ...
    <div className="wrapper clear">
      <header className='d-flex justify-between align-center p-40 ' >
          ...
          <ul className='headerRight d-flex' >
              ...
              <li >
                  <svg className='liked' width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg className='user' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="card">
                    ...
                    <div className="d-flex justify-between align-center">
                        <div className="d-flex flex-column">
                            <span className='sneakersPrice'>ЦЕНА:</span>
                            <b className='sneakersCost'>12 999 руб.</b>
                        </div>
